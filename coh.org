...
#+HTML_HEAD: <style>
#+HTML_HEAD: @font-face {font-family: 'goudy'; src: url('./goudy.TTF') format('truetype');}
#+HTML_HEAD: @font-face {font-family: 'goudy italic'; src: url('./goudy_italic.ttf') format('truetype');}
#+HTML_HEAD: @font-face {font-family: 'goudy bold'; src: url('./goudy_bold.ttf') format('truetype');}
#+HTML_HEAD: @font-face {font-family: 'bulkyRefuse'; src: url('./bulkyRefuse.ttf') format('truetype');}
#+HTML_HEAD: h3{clear:both;}
#+HTML_HEAD: table {width:100%}
#+HTML_HEAD: h1, h2, h3, h4 {font-family: 'bulkyRefuse Type'}
#+HTML_HEAD: h1 { text-align: center; }
#+HTML_HEAD: </style>


* Introduction
#+ATTR_HTML: :style width:calc(100% + 100px);position:relative;left:-100px;
[[./dragon_knight.png]]
...
This page is meant to be a quick lookup for resources on how to build your character, but if you read Chronicles of Darkness (or the relevant book for your supernatural species) you already know how to do it.

Also, these pages don't really explain many of the mechanics, so you need the Chronicles of Darkness book anyway. This is just a reference card.
...
Here's [[https://whitewolf.fandom.com/wiki/List_of_Merits_(Storytelling_System)][a list]] - do note that there are MANY merits you can take, and not all of them are equally fitting for you, though all are beneficial. So instead, try to work out what you want for your character, and then find the merit that best fits.

Some good questions to ask:
What is a unique trait to your character? If people asked about "do you know Tim?" would they ask "the guy with the big mansion?" or "the karate guy?"
Are money almost part of your personality? Horses? The time you spent on that island?

Generally mertis comes in ranks 1 to 5. 1 is a unique, but minor aspect of your character, such as better eyes, fantastic memory, etc. 5 makes you famous world wide for having that trait - not neccesarily to everyone, and some traits are about not being known, but 5 ranks in a martial art makes you a master, for instance. 5 ranks in resources makes you a proper millionaire. 3 would be something that people close to you, absolutely know about you "Oh, Jim is in the army, you could blindfold him and drop him off anywhere and he would be fine waiting 3 days before finding his way back home."

Some merits are genetic, such as better looks, good memory, being tall or big, having good health, etc. Some are about experiences, such as jobs, skills, training. Some are about social connections and resources that you have - friends, family, organizations.
...
** Hubris
All heroes struggle with hubris. Being so much better than anyone else means that you are in danger of losing your grasp on reality and your connection with the world around you.
Whenever you do something awesome, that lesser men would be unable to, you roll for hubris. On a failure, you lose 1 hubris, and is closer to losing your sense of self.

If your hubris ever hits 1, you become an npc that will take on any challenge, and take everything to the extreme. Hear of somebody having their wallet stolen? Vow to neither eat nor sleep, until you've removed crimed from this world! Somebody died? You'll travel to hell yourself, to bring them back! Saw a bear in the forest? Challenge the bear God to a duel!
...
#+ATTR_HTML: :style float:right;width:30%;margin:1em;clear:both;
[[./elf.png]]

** Night elves:

#+ATTR_HTML: :style float:right;width:30%;margin:1em;
[[./elf_female.png]]
...
[[./CoH_sheet.pdf][*Hero sheet*]]

[[./mage_sheet.pdf][*Mage sheet*]]
